...
class JacoReachPushPickPlaceEnv(JacoXYZEnv):
    ...
    @property
    def model_name(self):
        return get_asset_full_path('jaco_xyz/jaco_reach_push_pick_and_place.xml')
    ...
    def _reset_hand(self):
        ...
        self.init_fingerCOM  = [1.0, 1.0, 1.0] #(rightFinger + leftFinger)/2
    ...
    def compute_reward(self, actions, obs, mode = 'general', task_type='reach'):
        ...
        # rightFinger, leftFinger = self.get_site_pos('rightEndEffector'), self.get_site_pos('leftEndEffector')
        fingerCOM  =  [1.0, 1.0, 1.0]#(rightFinger + leftFinger)/2
